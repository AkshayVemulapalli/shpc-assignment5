...
void trmm_lunn_unb_var1( FLA_Obj, FLA_Obj );
...
int main(int argc, char *argv[])
{
    ...
    for ( n=nfirst; n<= nlast; n+=ninc ){
        ...
        /* Generate random matrix U and B */
        ...
        for ( irep=0; irep<nrepeats; irep++ ) {
            ...
            /* Compute Bref = L Bref where L is lower triangular stored in the
               ...
               correct result. */
            FLA_Trmm( FLA_LEFT, FLA_UPPER_TRIANGULAR, FLA_NO_TRANSPOSE, FLA_NONUNIT_DIAG, FLA_ONE, Uobj, Bref );
